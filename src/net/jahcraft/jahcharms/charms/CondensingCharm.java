...
public class CondensingCharm extends ItemStack {
	
	public CondensingCharm() {
		
		super(Material.NETHER_STAR);
		
		ItemMeta meta = getItemMeta();
		meta.setCustomModelData(42);
		meta.setDisplayName(ChatColor.of("#FFD700") + "Condensing Charm");
		...
		lore.add(ChatColor.of("#00E8FF") + "condense any materials placed");
